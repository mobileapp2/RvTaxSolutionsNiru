...
import com.ultronyc.rvtaxsolutions.BuildConfig;
...
public class UploadBusinessReturnDocActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_business_return_doc);
        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        pref = PreferenceManager.getDefaultSharedPreferences(UploadBusinessReturnDocActivity.this);
        ...
        textviewTitle.setText("Business Return Document Upload");
        ...
        transactionId = intent.getStringExtra("br_registration_no");
        ...
        selectImageBtn_pancard = (Button) findViewById(R.id.selectImageBtn_pancard);
        imageNameTv_pancard = (TextView) findViewById(R.id.imageNameTv_pancard);
        selectedImage_pancard = (ImageView) findViewById(R.id.selectedImage_pancard);
        imageDisplayCard_pancard = (CardView) findViewById(R.id.imageCard_pancard);

        selectImageBtn_aadharcard = (Button) findViewById(R.id.selectImageBtn_aadharcard);
        imageNameTv_aadharcard = (TextView) findViewById(R.id.imageNameTv_aadharcard);
        selectedImage_aadharcard = (ImageView) findViewById(R.id.selectedImage_aadharcard);
        imageDisplayCard_aadharcard = (CardView) findViewById(R.id.imageCard_aadharcard);

        selectImageBtn_bankproof = (Button) findViewById(R.id.selectImageBtn_bankproof);
        imageNameTv_bankproof = (TextView) findViewById(R.id.imageNameTv_bankproof);
        selectedImage_bankproof = (ImageView) findViewById(R.id.selectedImage_bankproof);
        imageDisplayCard_bankproof = (CardView) findViewById(R.id.imageCard_bankproof);

        selectImageBtn_lic = (Button) findViewById(R.id.selectImageBtn_lic);
        imageNameTv_lic = (TextView) findViewById(R.id.imageNameTv_lic);
        selectedImage_lic = (ImageView) findViewById(R.id.selectedImage_lic);
        imageDisplayCard_lic = (CardView) findViewById(R.id.imageCard_lic);

        selectImageBtn_other = (Button) findViewById(R.id.selectImageBtn_other);
        imageNameTv_other = (TextView) findViewById(R.id.imageNameTv_other);
        selectedImage_other = (ImageView) findViewById(R.id.selectedImage_other);
        imageDisplayCard_other = (CardView) findViewById(R.id.imageCard_other);
        ...
        selectImageBtn_other.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                doc_type=5;
                if (checkPermissionSts(READ_STORAGE_PER_CODE)) {
        ...
        imageNameTv_other.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        submitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    if (imagePath_bankproof == null) {
                        ...
                        uploadAttachedFilesNew_bankproof();
                    }

                    if (imagePath_lic == null) {
                    } else {
                        uploadAttachedFilesNew_lic();
                    }

                    if (imagePath_other == null) {
                    } else {
                        uploadAttachedFilesNew_other();
                    }
...
//                            });
                            ...
                            if (!response.isSuccessful()) {
                               ...
                               // getFileUploadStatus_lic(imageName_lic, false);
                        ...
                        //getFileUploadStatus_lic(imageName_lic, true);
    ...
    private void uploadAttachedFilesNew_other() {

        selectImageBtn_other.setEnabled(false);
        submitBtn.setEnabled(false);
//        skipUploadAndSubmitFormBtn.setEnabled(false);
        selectImageBtn_other.setAlpha(0.5f);
        submitBtn.setAlpha(0.5f);
        // skipUploadAndSubmitFormBtn.setAlpha(0.5f);
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                File files = new File(imagePath_other);

                if (files.exists()) {

                    if (!imageUploadStatus_other) {
...
//                    String content_type = getMimeType("/storage/sdcard1/FileUpload.xls");
                        ...
                        File file = new File(imagePath_other);
                        String content_type = getMimeType(imagePath_other);
...
//                            });
                            ...
                            if (!response.isSuccessful()) {
                               ...
                               // getFileUploadStatus_other(imageName_other, false);
                              //  getFileUploadStatus_pancard(imageName_pancard, false);
                       ...
                       // getFileUploadStatus_other(imageName_other, true);
                       // getFileUploadStatus_pancard(imageName_pancard, true);
                    ...
                    //Toasty.error(GenerateRequestActivity.this, "", Toasty.LENGTH_LONG).show();
                    if (imageNameTv_other.length() > 15) {
    ...
    private void getFileUploadStatus_pancard(String filename, boolean isUploaded) {
                                                ...
                                                if (!imageUploadStatus_pancard) {
                                                 ...
                                                 //   skipUploadAndSubmitFormBtn.setEnabled(true);
                                                  ...
                                                  //  skipUploadAndSubmitFormBtn.setAlpha(1);
                                                    ...
                                                    Intent intent = new Intent(UploadBusinessReturnDocActivity.this, paymentMainactivity.class);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(UploadBusinessReturnDocActivity.this);
            ...
            if (resultCode == RESULT_OK) {
                ...
                try {
                    ...
                    if (matcher.find() || matcherEnd.find()) {
                        ...
                        new KAlertDialog(UploadBusinessReturnDocActivity.this, KAlertDialog.ERROR_TYPE)
                                .setTitleText("Error!")
    ...
    private void requestForPermission(int perCode) {
        ...
        if (perCode == READ_STORAGE_PER_CODE) {
            ...
            ActivityCompat.requestPermissions(UploadBusinessReturnDocActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, perCode);

        } else if (perCode == WRITE_STORAGE_PER_CODE) {

            ActivityCompat.requestPermissions(UploadBusinessReturnDocActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, perCode);

        } else if(perCode == CAMERA_CAPTURE_PERMISSION){

            ActivityCompat.requestPermissions(UploadBusinessReturnDocActivity.this, new String[]{Manifest.permission.CAMERA}, perCode);
    ...
    private boolean checkPermissionSts(int perCode) {
        ...
        int status = ContextCompat.checkSelfPermission(UploadBusinessReturnDocActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE);
    ...
    private boolean checkCameraPermission(){
        ...
        int status = ContextCompat.checkSelfPermission(UploadBusinessReturnDocActivity.this, Manifest.permission.CAMERA);
