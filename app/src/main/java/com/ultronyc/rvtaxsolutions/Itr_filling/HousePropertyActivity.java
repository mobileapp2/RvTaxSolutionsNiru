...
public class HousePropertyActivity extends AppCompatActivity {
    ...
    String URL_MAINSUBMIT = "http://rvtaxs.com/android/house_property_master.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pref = PreferenceManager.getDefaultSharedPreferences(HousePropertyActivity.this);
        ...
        textviewTitle.setText("ITR House Property");
        ...
        full_name = (EditText) findViewById(R.id.HP_full_name);
        mobile_number = (EditText) findViewById(R.id.HP_mobile_number);

        email = (EditText) findViewById(R.id.HP_email);


        submit = (Button) findViewById(R.id.HP_submit);


        view_doc_list = (TextView) findViewById(R.id.HP_view_doc_list);

        view_doc_list.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //createdDialog(0).show();
                DialogHousePropertyDocument dialog = new DialogHousePropertyDocument();
    ...
    private void  doSubmit(String full_name,String email,String mobile_no)
    {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            String hp_registration_no = null;
                            String amt = null;
                            String email = null;
                            String number = null;
                            String message = null;
                            for(int i = 0; i<ja.length(); i++){
                                ...
                                if(message.equals("1")) {
                                    hp_registration_no = jo.getString("hp_registration_no");
                            ...
                            if(message.equals("1")){
                                ...
                                if(hp_registration_no != null){
                                    Intent intent = new Intent(HousePropertyActivity.this, UploadHousePropertyDocActivity.class);
                                    intent.putExtra("hp_registration_no", hp_registration_no);
                                ...
                                new KAlertDialog(HousePropertyActivity.this, KAlertDialog.ERROR_TYPE)
                                        .setTitleText("Error!")
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(HousePropertyActivity.this);
